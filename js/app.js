...
app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    .state('scriptUp', {
        url: '/scriptUp',
        templateUrl: 'html/partials/scriptUp.html',
        controller: 'scriptUpController'
    })
    ...
    .state('genPack', {
        ...
        .state('genPack.cart', {
            url: '/cart',
            templateUrl: 'html/partials/genPack.html',
            controller: 'genPackController'
        })
        .state('genPack.copy', {
            url: '/copy',
            templateUrl: 'html/partials/genPack.html',
...
app.run(['$timeout', '$urlRouter', '$rootScope', '$state', 'User',
    function ($timeout, $urlRouter, $rootScope, $state, User) {
        $rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
            ...
            if (!User.checkUser() && toState.name.toLowerCase() != 'login') {
